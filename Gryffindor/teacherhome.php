	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="teacherhome2.php"><i class="icon-study"></i>GRYFFINDOR Education<span>.</span></a></div>
					</div>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
      ...
      <a href="createclass.php"><span  class="glyphicon glyphicon-plus"></span>Create class</a>
      <a href="https://www.youtube.com/webcam"><span  class="glyphicon glyphicon-plus"></span> live class</a>
      <a href="https://www.youtube.com/upload"><span  class="glyphicon glyphicon-expand"></span> post video</a>
					...
					<form action="#">
						<div class="row form-group">
							...
							<div class="col-md-6">
								...
								<input type="text" id="lname" class="form-control" placeholder="Your class name">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="post here"></textarea>
							</div>
						</div>
